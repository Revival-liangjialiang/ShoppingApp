...
import static com.example.k.shoppingapp.R.color.History_record_button_color;

/**
 * Created by k on 2016/8/9.
 */
public class DynamicTagFlowLayout extends ViewGroup {
   public TextView[] button_attay = new TextView[100];
...
//  lp.height = MarginLayoutParams.WRAP_CONTENT;
                ...
                tv.setTextColor(Color.parseColor("#BBC1CD"));
                tv.setBackgroundResource(R.drawable.history_search_button_background);
  /*
